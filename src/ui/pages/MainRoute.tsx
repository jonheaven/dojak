...
import CharmsCollectionScreen from './Charms/CharmsCollectionScreen';
import CharmsNFTScreen from './Charms/CharmsNFTScreen';
...
// import SendDoginalsInscriptionScreen from './Doginals/SendDoginalsInscriptionScreen';
...
export const routes = {
  ...
  // Commenting out missing Doginals screens for development
  ...
  //   },
  //   element: <DoginalsInscriptionScreen />
  // },

  // SendDoginalsInscriptionScreen: {
  //   path: '/wallet/doginals-tx/create',
  //   element: <SendDoginalsInscriptionScreen />
  // },

  // SignDoginalsTransactionScreen: {
  //   path: '/wallet/doginals-tx/confirm',
  //   element: <SignDoginalsTransactionScreen />
  // },
  ...
  //   path: '/drc20/send-single-step',
  //   element: <DRC20SingleStepScreen />
  // },

  SendCharmsScreen: {
    path: '/Charms/send-token',
    element: <SendCharmsScreen />
  },
  CharmsTokenScreen: {
    path: '/Charms/token',
    element: <CharmsTokenScreen />
  },
  CharmsCollectionScreen: {
    path: '/Charms/collection',
    element: <CharmsCollectionScreen />
  },
  CharmsNFTScreen: {
    path: '/Charms/nft',
    element: <CharmsNFTScreen />
  },
  SendCharmsNFTScreen: {
    path: '/Charms/send-nft',
    element: <SendCharmsNFTScreen />
  }
};
