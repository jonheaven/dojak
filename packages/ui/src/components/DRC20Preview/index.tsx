import { TickPriceItem } from '@dojak/core/types';
import { TickUsd, TickUsdWithoutPrice, TokenType } from '@dojak/ui/components/TickUsd';
...
export interface DRC20PreviewProps {
  tick: string;
  balance?: string;
...
export default function DRC20Preview({
  tick,
  balance,
  inscriptionNumber,
  timestamp,
    ...
    >
      ...
      >
        <Row
          ...
          px="sm"
        >
          <DRC20Ticker tick={tick} preset={tickerPreset} />
        </Row>
      </Row>
      <Column
        style={{
      ...
      >
        ...
        {type === 'TRANSFER' && priceInProps ? (
          ...
          <TickUsdWithoutPrice tick={tick} balance={balance} type={TokenType.DRC20} />
        )}
      </Column>
