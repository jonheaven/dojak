...
export default function DunesBalanceCard({ tokenBalance, showPrice = true, price, onClick }: DunesBalanceCardProps) {
  return <DunesPreviewCard balance={tokenBalance} price={showPrice ? price : undefined} onClick={onClick} />;
}
