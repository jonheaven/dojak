...
import { Button, Content, Footer, Header, Layout, Row } from '@dojak/ui/components';
import { useI18n } from '@dojak/ui/hooks/useI18n';
import { useWallet } from '@dojak/ui/utils';

import { Step1, Step2, USBStep, KeystoneConnectionType, KeystoneStep } from './SignSteps';
...
export default function KeystoneSignBase(props: KeystoneSignBaseProps) {
  ...
  const [connectionType, setConnectionType] = useState<KeystoneConnectionType | undefined>(undefined);
