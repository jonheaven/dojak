...
import { DecodedPsbt, Risk, RiskType } from '@dojak/core/types';
...
import { DunesBurningList } from './DunesBurningList';
...
function getRiskContentKey(riskType: RiskType) {
  switch (riskType) {
    ...
    case RiskType.Charms_BURNING:
      return {
        title: 'Charms_burning_risk_title',
        description: 'Charms_burning_risk_description'
      };
    case RiskType.Charms_MULTIPLE_ASSETS:
      return {
        title: 'Charms_multiple_assets_risk_title',
        description: 'Charms_multiple_assets_risk_description'
      };
