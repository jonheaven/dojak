...
import { getAutoLockTimes } from '@dojak/core/constant';
...
import { useAutoLockTimeId } from '@dojak/ui/state/settings/hooks';
import { settingsActions } from '@dojak/ui/state/settings/reducer';
