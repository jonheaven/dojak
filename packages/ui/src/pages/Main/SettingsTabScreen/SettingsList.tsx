...
import { ADDRESS_TYPES, FEEDBACK_URL, REVIEW_URL } from '@dojak/core/constant';
import { Button, Card, Column, Row, Text } from '@dojak/ui/components';
import { useTools } from '@dojak/ui/components/ActionComponent';
import { Icon } from '@dojak/ui/components/Icon';
import { ThemeToggle } from '@dojak/ui/components/ThemeToggle';
import { getCurrentTab, useExtensionIsInTab, useOpenExtensionInTab } from '@dojak/ui/features/browser/tabs';
import { useI18n } from '@dojak/ui/hooks/useI18n';
import { SwitchChainModal } from '@dojak/ui/pages/Settings/SwitchChainModal';
import { useCurrentAccount } from '@dojak/ui/state/accounts/hooks';
import { useCurrentKeyring } from '@dojak/ui/state/keyrings/hooks';
import { useChain, useVersionInfo } from '@dojak/ui/state/settings/hooks';
