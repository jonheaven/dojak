...
import { NetworkType, ToAddressInfo, TxType } from '@dojak/core/types';
import { Card, Column, Content, Input, Layout, Text } from '@dojak/ui/components';
import { AddressDetailPopover } from '@dojak/ui/components/AddressDetailPopover';
import { AddressText } from '@dojak/ui/components/AddressText';
import { AddressTypeCard } from '@dojak/ui/components/AddressTypeCard';
import { RemoveWalletPopover } from '@dojak/ui/components/RemoveWalletPopover';
...
export default function TestScreen() {
  ...
  if (testComponent === 'CharmsSign') {
    return <TestCharmsSign />;
  }
...
const testAddressInfo = {
  ...
  inscription: {
    ...
    address: 'tb1q8h8s4zd9y0lkrx334aqnj4ykqs220ss7mjxzny',
    outputValue: 546,
    preview: 'https://doginals.com/preview/8436ee125d5cff80292e1ae3efdcde9880f020b63c5ee0f08a39865fc534ec36i0',
    content: 'https://doginals.com/content/8436ee125d5cff80292e1ae3efdcde9880f020b63c5ee0f08a39865fc534ec36i0',
    contentLength: 40,
          ...
          dunes: [
            {
              ...
              runeid: '840002:4',
              spacedDune: 'AMAZING•PYRAMID•NUMBER',
              amount: '39',
              symbol: '₦',
              divisibility: 0
            }
