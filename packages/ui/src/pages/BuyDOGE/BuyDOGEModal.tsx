...
import { PAYMENT_CHANNELS, PaymentChannelType } from '@dojak/core/constant';
import { DogeChannelItem } from '@dojak/core/types';
...
function PaymentItem({ channel, onClick }: { channel: DogeChannelItem; onClick: () => void }) {
...
export const BuyDOGEModal = ({ onClose }: { onClose: () => void }) => {
  ...
  const { t } = useI18n();
  const [channels, setChannels] = useState<DogeChannelItem[] | undefined>(undefined);
