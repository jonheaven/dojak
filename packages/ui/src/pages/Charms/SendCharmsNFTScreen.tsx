...
import { CharmsInfo, Inscription, TxType, UserToSignInput } from '@dojak/core/types';
...
import { isValidAddress, useWallet } from '@dojak/ui/utils';
...
export default function SendCharmsNFTScreen() {
      ...
      <SignPsbt
        ...
        handleConfirm={async (res) => {
          ...
          try {
            ...
            const step3 = await wallet.signCharmsSendTx({
  ...
  return (
    <Layout>
      ...
      <Content>
        <Row justifyCenter>
          <CharmsNFTPreview CharmsInfo={CharmsInfo} preset="medium" />
        </Row>
