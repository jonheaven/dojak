    ...
    <div className="p-4 max-w-4xl mx-auto">
      ...
      <Card className="mb-6 bg-[#262222] border-[#333]">
        <div className="flex gap-2">
          <Input
            placeholder="Search for .doge domain (e.g., jon.doge)"
            value={searchQuery}
          ...
          <div className="mt-4 p-4 bg-[#1a1a1a] rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <div className="text-white font-medium text-lg">{searchResult.name}.doge</div>
      ...
      <Card className="bg-[#262222] border-[#333]">
        ...
        {domains.length === 0 ? (
          <Empty description="No domains found. Register your first .doge domain!" className="text-gray-400" />
        ) : (
          <List
            dataSource={domains}
            renderItem={(domain) => (
              ...
              >
                <List.Item.Meta
                  avatar={<Avatar src={domain.avatar} icon={<GlobalOutlined />} className="border border-[#069420]" />}
                  ...
                  description={
                    <div className="text-gray-400 text-sm">
                      ...
                      <div className="mt-1">Registered: {new Date(domain.timestamp * 1000).toLocaleDateString()}</div>
                    </div>
                  }
                />
              </List.Item>
