...
import { Button, Column, Content, Input, Layout, Row, Text } from '@dojak/ui/components';
import { useTools } from '@dojak/ui/components/ActionComponent';
import { useI18n } from '@dojak/ui/hooks/useI18n';
import { useWallet, useWalletRequest } from '@dojak/ui/utils';
import { getPasswordStrengthWord, MIN_PASSWORD_LENGTH } from '@dojak/ui/utils/password-utils';
