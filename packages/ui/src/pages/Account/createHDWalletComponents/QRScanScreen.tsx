import { AddressType } from '@dojak/core/types';
import { Content, Header, Layout, Row, Text } from '@dojak/ui/components';
import { useTools } from '@dojak/ui/components/ActionComponent';
import QRScanner from '@dojak/ui/components/QRScanner';
import { useCreateAccountCallback } from '@dojak/ui/state/global/hooks';
import { globalActions } from '@dojak/ui/state/global/reducer';
