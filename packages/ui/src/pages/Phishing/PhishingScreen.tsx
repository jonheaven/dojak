    ...
    <div className="phishing-container">
      <div className="phishing-content">
        ...
        <div className="phishing-header">
          <img src={chrome.runtime.getURL('/images/logo/wallet-logo.png')} alt="Dojak" className="phishing-logo" />
        ...
        <div className="phishing-warning-box">
          <p>{t('this_website_has_been_identified_as_malicious_by_dojak_and_may')}</p>
          <ul>
