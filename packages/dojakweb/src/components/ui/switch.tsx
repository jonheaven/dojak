...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      'peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border border-white/15 shadow-inner transition-colors',
      ...
      'data-[state=checked]:border-amber-500/50 data-[state=checked]:bg-amber-500/35',
