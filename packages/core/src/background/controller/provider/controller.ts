import { permissionService, preferenceService, sessionService, walletApiService } from '@dojak/core/background/service';
import { CHAINS, CHAINS_MAP, NETWORK_TYPES, VERSION } from '@dojak/core/constant';
...
import { amountToKoinu } from '@dojak/ui/utils';
import { bitcoin, verifyMessageOfBIP322Simple } from '@unisat/wallet-bitcoin';
import { ethErrors } from 'eth-rpc-errors';
import BaseController from '../base';
import wallet from '../wallet';

import { formatPsbtHex } from '@dojak/core/background/utils/psbt-utils';
