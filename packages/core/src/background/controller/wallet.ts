...
import {
  ...
  sessionService,
  walletApiService
} from '@dojak/core/background/service';
import { psbtFromString } from '@dojak/core/background/utils/psbt-utils';
import {
  ADDRESS_TYPES,
  AddressFlagType,
  AUTO_LOCK_TIMES,
  ...
  KEYRING_TYPES,
  NETWORK_TYPES
} from '@dojak/core/constant';
import eventBus from '@dojak/core/eventBus';
import { getDogecoinNetwork } from '@dojak/core/lib/dogecoin-network';
import { dunestone } from '@dojak/core/lib/dunestone';
import { dunesUtils } from '@dojak/core/lib/dunes-utils';
import { createSignedMarketplaceIntent, prepareMarketplaceIntent } from '@dojak/core/lib/marketplace-intents';
import {
  Account,
...
import { getChainInfo } from '@dojak/core/utils';
import { dogecoinPublicKeyToAddress } from '@dojak/ui/utils/bitcoin-utils';
...
export class WalletController extends BaseController {
  ...
  checkWebsite = async (
    ...
    try {
      ...
      const phishingService = await import('@dojak/core/background/service/phishing');
